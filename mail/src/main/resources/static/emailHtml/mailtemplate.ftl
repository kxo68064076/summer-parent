        ...
        <tr>
            <td style="word-break:break-all">
                <div style="padding:25px 35px 40px; background-color:#fff;opacity:0.8;">
                    <!-- 中文 -->
                    <p>您好！感谢您使用麻豆传媒娱乐的上门服务，您的账号正在进行邮箱验证，验证码为：<font color="#ff8c00">{0}</font>，有效期30分钟，请尽快填写验证码完成验证！</p><br>
                    <!-- 英文 -->
                    ...
                    <p>Hello! Thanks for using Ma Dou Media Entertainment house service, your account is being authenticated by email, the
